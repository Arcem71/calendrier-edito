/*
  # Fix photo download trigger for image IDs
  
  1. Changes
    - Improve handling of newline-separated image IDs
    - Fix URL construction for Supabase Storage
    - Add proper error handling
    
  2. Features
    - Support for newline-separated IDs
...
BEGIN
  IF NEW.photo_download IS NOT NULL THEN
    ...
    IF NEW.images IS NULL OR NEW.images = 'null'::jsonb THEN
      NEW.images := '[]'::jsonb;
    END IF;
