/*
  ...
  1. Changes
    - Update trigger function to correctly construct storage URLs
    - Handle newline-separated UUIDs
    - Maintain proper image metadata structure
*/
...
BEGIN
  IF NEW.photo_download IS NOT NULL THEN
    ...
    LOOP
      ...
      SELECT rtrim(current_setting('supabase.project_url', true), '/') || '/storage/v1/object/public'
      INTO storage_url;
