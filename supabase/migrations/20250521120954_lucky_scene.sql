/*
  # Fix photo download trigger for newline-separated UUIDs
  
  1. Changes
    - Update trigger function to handle newline-separated UUIDs
    - Properly construct Supabase storage URLs
    - Fix image array handling
    
  2. Features
    - Support for multiple image IDs
    - Automatic URL construction using project URL
    - Maintains existing image metadata
*/
